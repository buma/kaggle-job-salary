...
#joblib.dump(features, "train_200f_noNorm_categoryTimeType_tfidfl2_features_jl", compress=5)
#joblib.dump(validation_features, "train_200f_noNorm_categoryTimeType_tfidfl2_valid_features_jl", compress=5)

    features = load("train_200f_noNorm_categoryTimeType_tfidfl2_features_jl")
    validation_features = load("train_200f_noNorm_categoryTimeType_tfidfl2_valid_features_jl")
